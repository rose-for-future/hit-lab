...
#
# Called by /hit-retro when state.data_collection=adapter and platform=xhs.
#
# Usage:
...
cd "$PROJECT_ROOT"
export HIT_PROJECT_ROOT="$PROJECT_ROOT"
export HIT_VIDEOS_DIR="$( dirname "$VIDEO_FOLDER" )"
...
# review.py writes to HIT_VIDEOS_DIR/<auto-named-folder>/report.md.
